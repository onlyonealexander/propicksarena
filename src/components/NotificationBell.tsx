...
export function NotificationBell() {
  ...
  return (
    <div ref={boxRef} className="relative">
      ...
      {open && (
        <div className="fixed sm:absolute left-3 right-3 sm:left-auto sm:right-0 top-[64px] sm:top-11 w-auto sm:w-[340px] max-h-[min(420px,calc(100vh-84px))] flex flex-col rounded-2xl border border-border bg-surface shadow-[0_12px_32px_rgba(0,0,0,0.5)] overflow-hidden z-50">
